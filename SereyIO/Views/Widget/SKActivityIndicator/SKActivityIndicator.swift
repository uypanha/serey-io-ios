...
//  RmaDriver
//
//  Created by Panha Uy on 8/17/21.
//  Copyright © 2021 Serey. All rights reserved.
//
...
public class SKActivityIndicator: NSObject {
    ...
    public static func show() {
        DispatchQueue.main.async {
            self.shared.configureActivityIndicator(withStatusMessage: "Loading...", isUserInteractionEnabled: false)
        }
    }
    ...
    public static func show(_ message: String) {
        DispatchQueue.main.async {
            self.shared.configureActivityIndicator(withStatusMessage: message, isUserInteractionEnabled: false)
        }
    }
