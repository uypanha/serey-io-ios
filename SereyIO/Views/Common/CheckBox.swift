...
//  BlooiOS
//
//  Created by Phanha Uy on 6/26/19.
...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var checkedBackgroundColor: UIColor! = #colorLiteral(red: 0, green: 0.3285208941, blue: 0.5748849511, alpha: 1)
    ...
    open override func draw(_ rect: CGRect) {
        ...
        context.setFillColor(self.isChecked ? checkedBackgroundColor.cgColor : uncheckedBackgroundColor.cgColor)
...
extension Reactive where Base: CheckBox {
    ...
    internal var checked: Binder<Bool> {
